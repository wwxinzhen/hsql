...
namespace hsql {
  ...
  //Prints a summary of the given DeleteStatement with the given indentation.
  void printDeleteStatementInfo(const DeleteStatement* stmt, uintmax_t num_indent);

  //Prints a summary of the given UpdateStatement with the given indentation.
